...
const socket = io('https://kkTravancore Backers-backend.onrender.com/'); // Replace with your server URL
...
const MapComponent = () => {
        ...
        return (
            <div className='text-center flex items-center justify-center h-screen overflow-hidden'>
                <div>
                    ...
                    <p className='text-xs font-bold mt-2 text-gray-300'>Travancore Backers</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className='mx-auto lg:w-1/2 text-center'>
            ...
            <h2 className='text-2xl font-bold text-red-600 mb-2'>Travancore Backers</h2>
